...
import { CamionesTable } from "../../../constant/table-data";
      ...
      return (
        <div>
          <ProgressBar
            ...
            ${row?.cell?.value > 30 && row?.cell?.value < 69 ? "bg-yellow-500" : ""} 
    ...
    Cell: (row) => {
      return (
        <span className="block w-full text-center">
          <span
            className={` inline-block px-3 min-w-[90px] text-center mx-auto py-1 rounded-[999px] bg-opacity-25 ${row?.cell?.value === "encendido"
              ? "text-success-500 bg-success-500"
              : ""
              } 
            ${row?.cell?.value === "apagado"
...
const UnidadesTable = () => {
  ...
  const data = useMemo(() => CamionesTable, []);
